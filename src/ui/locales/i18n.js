...
const I18N = {
  "en": {
    ...
    "help": {
      ...
      "appUpdateAlphaAvailable": "Alpha update available",
      "appUpdateReleaseAvailable": "Release update available",
      "appUpdateAlphaTitle": "Alpha Update Available",
      "appUpdateReleaseTitle": "Release Update Available",
      "appUpdateChoicesTitle": "Update Guide",
      "updateGuideHint": "Choose a version channel to continue.",
      "appUpdateAlphaBody": "A newer alpha version is available. Open the latest beta tag page?",
      "appUpdateReleaseBody": "A newer stable version is available. Open the stable release tag page?",
      "appUpdateAlphaBodyVersion": "A newer alpha version v{version} is available. Open the latest beta tag page?",
      "appUpdateReleaseBodyVersion": "A newer stable version v{version} is available. Open the stable release tag page?",
      "appUpdateAlphaAction": "Update to Alpha",
      "appUpdateReleaseAction": "Update Release",
  ...
  "zh": {
    ...
    "help": {
      ...
      "appUpdateAlphaAvailable": "发现 Alpha 更新",
      "appUpdateReleaseAvailable": "发现 Release 更新",
      "appUpdateAlphaTitle": "发现 Alpha 更新",
      "appUpdateReleaseTitle": "发现 Release 更新",
      "appUpdateChoicesTitle": "更新指引",
      "updateGuideHint": "选择一个版本通道继续。",
      "appUpdateAlphaBody": "检测到新的 Alpha 版本，是否打开最新 Beta Tag 页面？",
      "appUpdateReleaseBody": "检测到新的稳定版本，是否打开稳定版 Tag 页面？",
      "appUpdateAlphaBodyVersion": "检测到新的 Alpha 版本 v{version}，是否打开最新 Beta Tag 页面？",
      "appUpdateReleaseBodyVersion": "检测到新的稳定版本 v{version}，是否打开稳定版 Tag 页面？",
      "appUpdateAlphaAction": "更新到 Alpha",
      "appUpdateReleaseAction": "更新 Release",
  ...
  "ja": {
    ...
    "help": {
      ...
      "appUpdateAlphaAvailable": "Alpha 更新があります",
      "appUpdateReleaseAvailable": "Release 更新があります",
      "appUpdateAlphaTitle": "Alpha 更新があります",
      "appUpdateReleaseTitle": "Release 更新があります",
      "appUpdateChoicesTitle": "更新ガイド",
      "updateGuideHint": "続行するバージョンチャンネルを選択してください。",
      "appUpdateAlphaBody": "新しい Alpha バージョンがあります。最新の Beta タグページを開きますか？",
      "appUpdateReleaseBody": "新しい安定版があります。安定版タグページを開きますか？",
      "appUpdateAlphaBodyVersion": "新しい Alpha バージョン v{version} があります。最新の Beta タグページを開きますか？",
      "appUpdateReleaseBodyVersion": "新しい安定版 v{version} があります。安定版タグページを開きますか？",
      "appUpdateAlphaAction": "Alpha に更新",
      "appUpdateReleaseAction": "Release を更新",
  ...
  "ko": {
    ...
    "help": {
      ...
      "appUpdateAlphaAvailable": "Alpha 업데이트 사용 가능",
      "appUpdateReleaseAvailable": "Release 업데이트 사용 가능",
      "appUpdateAlphaTitle": "Alpha 업데이트 사용 가능",
      "appUpdateReleaseTitle": "Release 업데이트 사용 가능",
      "appUpdateChoicesTitle": "업데이트 안내",
      "updateGuideHint": "계속할 버전 채널을 선택하세요.",
      "appUpdateAlphaBody": "새 Alpha 버전이 있습니다. 최신 Beta 태그 페이지를 열까요?",
      "appUpdateReleaseBody": "새 안정 버전이 있습니다. 안정 버전 태그 페이지를 열까요?",
      "appUpdateAlphaBodyVersion": "새 Alpha 버전 v{version} 이 있습니다. 최신 Beta 태그 페이지를 열까요?",
      "appUpdateReleaseBodyVersion": "새 안정 버전 v{version} 이 있습니다. 안정 버전 태그 페이지를 열까요?",
      "appUpdateAlphaAction": "Alpha로 업데이트",
      "appUpdateReleaseAction": "Release 업데이트",
  ...
  "fr": {
    ...
    "help": {
      ...
      "appUpdateAlphaAvailable": "Mise à jour Alpha disponible",
      "appUpdateReleaseAvailable": "Mise à jour Release disponible",
      "appUpdateAlphaTitle": "Mise à jour Alpha disponible",
      "appUpdateReleaseTitle": "Mise à jour Release disponible",
      "appUpdateChoicesTitle": "Guide de mise à jour",
      "updateGuideHint": "Choisissez un canal de version pour continuer.",
      "appUpdateAlphaBody": "Une nouvelle version Alpha est disponible. Ouvrir la page du dernier tag Beta ?",
      "appUpdateReleaseBody": "Une nouvelle version stable est disponible. Ouvrir la page du tag stable ?",
      "appUpdateAlphaBodyVersion": "Une nouvelle version Alpha v{version} est disponible. Ouvrir la page du dernier tag Beta ?",
      "appUpdateReleaseBodyVersion": "Une nouvelle version stable v{version} est disponible. Ouvrir la page du tag stable ?",
      "appUpdateAlphaAction": "Mettre à jour vers Alpha",
      "appUpdateReleaseAction": "Mettre à jour Release",
  ...
  "de": {
    ...
    "help": {
      ...
      "appUpdateAlphaAvailable": "Alpha-Update verfügbar",
      "appUpdateReleaseAvailable": "Release-Update verfügbar",
      "appUpdateAlphaTitle": "Alpha-Update verfügbar",
      "appUpdateReleaseTitle": "Release-Update verfügbar",
      "appUpdateChoicesTitle": "Update-Leitfaden",
      "updateGuideHint": "Wählen Sie einen Versionskanal, um fortzufahren.",
      "appUpdateAlphaBody": "Eine neue Alpha-Version ist verfügbar. Soll die neueste Beta-Tag-Seite geöffnet werden?",
      "appUpdateReleaseBody": "Eine neue stabile Version ist verfügbar. Soll die stabile Tag-Seite geöffnet werden?",
      "appUpdateAlphaBodyVersion": "Eine neue Alpha-Version v{version} ist verfügbar. Soll die neueste Beta-Tag-Seite geöffnet werden?",
      "appUpdateReleaseBodyVersion": "Eine neue stabile Version v{version} ist verfügbar. Soll die stabile Tag-Seite geöffnet werden?",
      "appUpdateAlphaAction": "Auf Alpha aktualisieren",
      "appUpdateReleaseAction": "Release aktualisieren",
  ...
  "ru": {
    ...
    "help": {
      ...
      "appUpdateAlphaAvailable": "Доступно Alpha-обновление",
      "appUpdateReleaseAvailable": "Доступно Release-обновление",
      "appUpdateAlphaTitle": "Доступно Alpha-обновление",
      "appUpdateReleaseTitle": "Доступно Release-обновление",
      "appUpdateChoicesTitle": "Руководство по обновлению",
      "updateGuideHint": "Выберите канал версии для продолжения.",
      "appUpdateAlphaBody": "Доступна новая Alpha-версия. Открыть страницу последнего Beta-тега?",
      "appUpdateReleaseBody": "Доступна новая стабильная версия. Открыть страницу стабильного тега?",
      "appUpdateAlphaBodyVersion": "Доступна новая Alpha-версия v{version}. Открыть страницу последнего Beta-тега?",
      "appUpdateReleaseBodyVersion": "Доступна новая стабильная версия v{version}. Открыть страницу стабильного тега?",
      "appUpdateAlphaAction": "Обновить до Alpha",
      "appUpdateReleaseAction": "Обновить Release",
