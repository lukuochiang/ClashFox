...
Users are required to install `mihomo` separately.
`mihomo` is an independent project and is licensed under its own license.
...
**ClashFox** - Make Mihomo kernel management a lot of fun!
